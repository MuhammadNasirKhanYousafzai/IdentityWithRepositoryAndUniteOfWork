...
namespace WebApplication1.Identity
{
    public class UserStore : IUserLoginStore<IdentityUser, Guid>, IUserClaimStore<IdentityUser, Guid>, IUserRoleStore<IdentityUser, Guid>, IUserPasswordStore<IdentityUser, Guid>, IUserSecurityStampStore<IdentityUser, Guid>, IUserStore<IdentityUser, Guid>, IDisposable
    {
        ...
        public Task AddClaimAsync(IdentityUser user,System.Security.Claims.Claim claim)
        {
            ...
            var c = new Application.Domain.Entities.Claim
            {
        ...
        public Task AddLoginAsync(IdentityUser user, UserLoginInfo login)
        {
            ...
            var l = new Application.Domain.Entities.ExternalLogin
            {
        ...
        private Application.Domain.Entities.User getUser(IdentityUser identityUser)
        {
        ...
        private void populateUser(Application.Domain.Entities.User user, IdentityUser identityUser)
        {
        ...
        private IdentityUser getIdentityUser(Application.Domain.Entities.User user)
        {
            if (user == null)
                return null;
        ...
        private void populateIdentityUser(IdentityUser identityUser, Application.Domain.Entities.User user)
        {
